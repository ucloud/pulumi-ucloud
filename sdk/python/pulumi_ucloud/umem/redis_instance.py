...
class RedisInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] duration: The duration that you will buy the Redis instance (Default: `1`). The value is `0` when pay by month and the instance will be valid till the last day of that month. It is not required when `dynamic` (pay by hour).
        :param pulumi.Input[str] engine_version: The version of engine of active-standby Redis. Possible values are: 3.0, 3.2, 4.0 and 5.0.
...
class _RedisInstanceState:
    def __init__(__self__, *,
                 ...
                 ip_sets: Optional[pulumi.Input[Sequence[pulumi.Input['RedisInstanceIpSetArgs']]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 password: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RedisInstanceIpSetArgs']]] ip_sets: ip_set is a nested type. ip_set documented below.
        :param pulumi.Input[str] password: The password for  active-standby Redis instance which should have 6-36 characters. It must contain at least 3 items of Capital letters, small letter, numbers and special characters. The special characters include `-_`.
    ...
    def ip_sets(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RedisInstanceIpSetArgs']]]]:
        """
    ...
    @ip_sets.setter
    def ip_sets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RedisInstanceIpSetArgs']]]]):
...
class RedisInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            expire_time: Optional[pulumi.Input[str]] = None,
            instance_type: Optional[pulumi.Input[str]] = None,
            ip_sets: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RedisInstanceIpSetArgs']]]]] = None,
            name: Optional[pulumi.Input[str]] = None,
            password: Optional[pulumi.Input[str]] = None,
            status: Optional[pulumi.Input[str]] = None,
            subnet_id: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] engine_version: The version of engine of active-standby Redis. Possible values are: 3.0, 3.2, 4.0 and 5.0.
        :param pulumi.Input[str] expire_time: The expiration time of Redis instance, formatted by RFC3339 time string.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RedisInstanceIpSetArgs']]]] ip_sets: ip_set is a nested type. ip_set documented below.
        :param pulumi.Input[str] password: The password for  active-standby Redis instance which should have 6-36 characters. It must contain at least 3 items of Capital letters, small letter, numbers and special characters. The special characters include `-_`.
        :param pulumi.Input[str] status: The status of KV Redis instance.
        :param pulumi.Input[str] subnet_id: The ID of subnet linked to the Redis instance.
        :param pulumi.Input[str] tag: A tag assigned to Redis instance, which contains at most 63 characters and only support Chinese, English, numbers, '-', '_', and '.'. If it is not filled in or a empty string is filled in, then default tag will be assigned. (Default: `Default`).
    ...
    @property
    @pulumi.getter(name="ipSets")
    def ip_sets(self) -> pulumi.Output[Sequence['outputs.RedisInstanceIpSet']]:
        """
        ip_set is a nested type. ip_set documented below.
        """
        return pulumi.get(self, "ip_sets")
