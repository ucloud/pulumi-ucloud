...
class GetVPNConnectionResult:
    ...
    """
    def __init__(__self__, id=None, ids=None, name_regex=None, output_file=None, tag=None, total_count=None, vpn_connections=None):
    ...
    def vpn_connections(self) -> Sequence['outputs.GetVPNConnectionVpnConnectionResult']:
        """
...
def get_vpn_connection(ids: Optional[Sequence[str]] = None,
    ...
    :param Sequence[str] ids: A list of VPN Connection IDs, all the VPN Connections belongs to the defined region will be retrieved if this argument is `[]`.
    ...
    __ret__ = pulumi.runtime.invoke('ucloud:ipsecvpn/getVPNConnection:getVPNConnection', __args__, opts=opts, typ=GetVPNConnectionResult).value
