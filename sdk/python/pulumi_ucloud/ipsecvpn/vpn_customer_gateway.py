...
class VpnCustomerGateway(pulumi.CustomResource):
    ...
    * ``
    """
    def __init__(__self__, resource_name, opts=None, ip_address=None, name=None, remark=None, tag=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, create_time=None, ip_address=None, name=None, remark=None, tag=None):
        """
