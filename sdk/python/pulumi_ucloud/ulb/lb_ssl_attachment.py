...
class LbSslAttachment(pulumi.CustomResource):
    ...
    ssl_id: pulumi.Output[str]
    """
    The ID of SSL certificate.
    """
    def __init__(__self__, resource_name, opts=None, listener_id=None, load_balancer_id=None, ssl_id=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, listener_id=None, load_balancer_id=None, ssl_id=None):
        """
