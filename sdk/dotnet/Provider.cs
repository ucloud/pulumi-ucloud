...
namespace Pulumi.ucloud
{
    ...
    public partial class Provider : Pulumi.ProviderResource
    {
        ...
        public Provider(string name, ProviderArgs? args = null, ResourceOptions? options = null)
            : base("ucloud", name, args ?? ResourceArgs.Empty, MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class ProviderArgs : Pulumi.ResourceArgs
    {
        ...
        public ProviderArgs()
        {
            PrivateKey = Utilities.GetEnv("UCLOUD_PRIVATE_KEY", "UCloud Private Key");
            Profile = Utilities.GetEnv("UCLOUD_PROFILE", "UCloud Profile Name");
            ProjectId = Utilities.GetEnv("UCLOUD_PROJECT_ID", "UCloud Project Id");
            PublicKey = Utilities.GetEnv("UCLOUD_PUBLIC_KEY", "UCloud Public Key");
            Region = Utilities.GetEnv("UCLOUD_REGION", "UCLOUD_DEFAULT_REGION");
            SharedCredentialsFile = Utilities.GetEnv("UCLOUD_SHARED_CREDENTIAL_FILE", "Path To The Shared Credentials File");
        }
    }
}
