...
namespace Pulumi.Ucloud.Udb
{
    ...
    /// ```
    /// </summary>
    [UcloudResourceType("ucloud:udb/dBInstance:DBInstance")]
    public partial class DBInstance : Pulumi.CustomResource
    {
        ...
        public Output<string> ParameterGroup { get; private set; } = null!;
        ...
        public DBInstance(string name, DBInstanceArgs args, CustomResourceOptions? options = null)
            : base("ucloud:udb/dBInstance:DBInstance", name, args ?? new DBInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class DBInstanceArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<string>? ParameterGroup { get; set; }
