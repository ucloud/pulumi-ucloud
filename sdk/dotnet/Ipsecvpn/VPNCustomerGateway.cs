...
namespace Pulumi.Ucloud.Ipsecvpn
{
    ...
    /// ```
    /// </summary>
    [UcloudResourceType("ucloud:ipsecvpn/vPNCustomerGateway:VPNCustomerGateway")]
    public partial class VPNCustomerGateway : Pulumi.CustomResource
    {
        ...
        public VPNCustomerGateway(string name, VPNCustomerGatewayArgs args, CustomResourceOptions? options = null)
            : base("ucloud:ipsecvpn/vPNCustomerGateway:VPNCustomerGateway", name, args ?? new VPNCustomerGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }
