...
namespace Pulumi.ucloud.unet
{
    ...
    public partial class SecurityGroup : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("rules")]
        public Output<ImmutableArray<Outputs.SecurityGroupRules>> Rules { get; private set; } = null!;
        ...
        public SecurityGroup(string name, SecurityGroupArgs args, CustomResourceOptions? options = null)
            : base("ucloud:unet/securityGroup:SecurityGroup", name, args ?? ResourceArgs.Empty, MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class SecurityGroupArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.SecurityGroupRulesArgs>? _rules;

        /// <summary>
        /// A list of security group rules. Can be specified multiple times for each rules. Each rules supports fields documented below.
        /// </summary>
        public InputList<Inputs.SecurityGroupRulesArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Inputs.SecurityGroupRulesArgs>());
            set => _rules = value;
        }
    ...
    public sealed class SecurityGroupState : Pulumi.ResourceArgs
    {
        ...
        [Input("rules")]
        private InputList<Inputs.SecurityGroupRulesGetArgs>? _rules;

        /// <summary>
        /// A list of security group rules. Can be specified multiple times for each rules. Each rules supports fields documented below.
        /// </summary>
        public InputList<Inputs.SecurityGroupRulesGetArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Inputs.SecurityGroupRulesGetArgs>());
            set => _rules = value;
        }
    ...
    public sealed class SecurityGroupRulesGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The cidr block of source.
        /// </summary>
        ...
        public SecurityGroupRulesGetArgs()
        {
        }
    }
    }
    ...
    [OutputType]
    public sealed class SecurityGroupRules
    {
        /// <summary>
        /// The cidr block of source.
        /// </summary>
