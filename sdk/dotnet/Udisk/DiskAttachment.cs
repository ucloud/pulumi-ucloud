...
namespace Pulumi.Ucloud.Udisk
{
    ...
    /// ```
    /// </summary>
    [UcloudResourceType("ucloud:udisk/diskAttachment:DiskAttachment")]
    public partial class DiskAttachment : Pulumi.CustomResource
    {
        ...
        public DiskAttachment(string name, DiskAttachmentArgs args, CustomResourceOptions? options = null)
            : base("ucloud:udisk/diskAttachment:DiskAttachment", name, args ?? new DiskAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DiskAttachment(string name, Input<string> id, DiskAttachmentState? state = null, CustomResourceOptions? options = null)
            : base("ucloud:udisk/diskAttachment:DiskAttachment", name, state, MakeResourceOptions(options, id))
        {
        }
